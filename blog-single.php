<?php include 'header.php';?>
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-80">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">Blog Single</h2>
          ...
          <div class="box-position" style="background-image: url(images/blogs/blog2.jpg);"></div>
        </div>
      </section>      
      
      <!-- Latest blog posts-->
      <section class="section section-top-70 section-fluid blogs-section text-left">
          <div class="container">
                ...
                <div class="row">
                  <div class="col-lg-12 mb-5">
                    <div class="single-blog-item">
                      <img src="images/blogs/blog2.jpg" alt="" class="img-fluid">
                      <div class="blog-item-content mt-5">
                        <div class="blog-item-meta mb-3">
                          ...
                          <span class="text-black text-capitalize mr-3"><i class="icofont-calendar mr-2"></i> 10th January 2024</span>
                        </div> 

                        <h4 class="mb-2 text-md"><a href="blog-single.php">Customer Experience & Signage Trends</a></h4>
                    ...
                    <div class="comment-area mt-4 mb-5">
                      ...
                      <ul class="comment-tree list-unstyled">
                        <li class="mb-5">
                          <div class="comment-area-box">
                            <div class="comment-thumb float-left">
                              <img alt="" src="images/blogs/testimonial1.jpg" class="img-fluid">
                            </div>
                        ...
                        <li>
                          <div class="comment-area-box">
                            <div class="comment-thumb float-left">
                              <img alt="" src="images/blogs/testimonial2.jpg" class="img-fluid">
                            </div>
                  ...
                  <div class="col-lg-12 bg-gray-300">
                    <form class="comment-form my-5" id="comment-form">
                      ...
                      <input class="btn button-secondary btn-round-full" type="submit" name="submit-contact" id="submit_contact" value="Submit Message">
                    </form>
                  </div>
                </div>
              </div>
